...
- **Set up Django REST Framework by creating serializers (in core/serializerspy)✅, views (in core/views.py) **July 19 2024: Views is in progress** , and defining URL routes (in core/urls.py) and include them in in backend/urls.py** ✅**July 19, 2024** 
