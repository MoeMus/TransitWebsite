    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('semester', models.CharField(choices=[('1', 'Spring'), ('2', 'Summer'), ('3', 'Fall')], default='2', max_length=10)),
                ('component', models.CharField(choices=[('LAB', 'Lab'), ('TUT', 'Tutorial'), ('SEM', 'Seminar')], default='LAB', max_length=10)),
            ],
        ),
        migrations.CreateModel(
            name='User',
